...
//        }
    ...
    private void updateChannelInfoView() {
    ...
    public void getChannelInfo(ChannelEnum channel, ChannelInfo channelInfo) {
        ...
        switch (channel) {
            case CHANNEL1:
                ...
                channelInfo.setmViewOffset(this.mChannelsOffset[0]);
                break;
            case CHANNEL2:
                ...
                channelInfo.setmViewOffset(this.mChannelsOffset[1]);
                break;
        }
    }
    ...
    public void setChannelInfo(ChannelEnum channel, ChannelInfo channelInfo) {
        switch (channel) {
            case CHANNEL1:
                ...
                this.mOscilloscopeApp.setChannelOffset(ChannelEnum.CHANNEL1, this.mChannelsOffset[0] * channelInfo.getVoltagePerDiv());
                break;
            case CHANNEL2:
                ...
                this.mOscilloscopeApp.setChannelOffset(ChannelEnum.CHANNEL2, this.mChannelsOffset[1] * channelInfo.getVoltagePerDiv());
                break;
        }
    }
    ...
    public void getTriggerInfo(TriggerInfo triggerInfoObj) {
        ...
        triggerInfoObj.setmTriggerLevel(this.mTriggerLevel);
        triggerInfoObj.setmTriggerEdge(this.mTriggerEdge);
        triggerInfoObj.setmTriggerChannel(this.mTriggerChannel);
        triggerInfoObj.setmSelected(this.mTriggerSelected);
    }
